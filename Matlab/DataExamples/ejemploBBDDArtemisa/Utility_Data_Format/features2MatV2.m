    ...
    for voluntarias=1:n_voluntarias
        ...
        for video=1:n_videos
            if(isfield(in.features{voluntarias, video},'EH'))
                ...
                temp=[];
                 temp(1:n2,1:22)=in.features{voluntarias, video}.EH.Video.HR_feats(1:n2,2:23);
                 temp(1:n2,23:29)=in.features{voluntarias, video}.EH.Video.GSR_feats(1:n2,:);
                 temp(1:n2,30:35)=in.features{voluntarias, video}.EH.Video.SKT_feats(1:n2,:);
                 temp(1:n2,36:47)=in.features{voluntarias, video}.EH.Video.RESP_feats(1:n2,:);

...
function features_mat_nt =featuresNTs(in_s)
for voluntaria=1:21
    %% Mean
...
%     features_mat_nt(4,voluntaria).features.a.mean_video=mean(resultados_nt_reordered(4,voluntaria).a);
    ...
    features_mat_nt.mean_video(1,voluntaria).da=mean(in_s(1,voluntaria).da);
    features_mat_nt.mean_video(2,voluntaria).da=mean(in_s(2,voluntaria).da);
    features_mat_nt.mean_video(3,voluntaria).da=mean(in_s(3,voluntaria).da);
    features_mat_nt.mean_video(4,voluntaria).da=mean(in_s(4,voluntaria).da);
    
   features_mat_nt.mean_video(1,voluntaria).na=mean(in_s(1,voluntaria).na);
    features_mat_nt.mean_video(2,voluntaria).na=mean(in_s(2,voluntaria).na);
    features_mat_nt.mean_video(3,voluntaria).na=mean(in_s(3,voluntaria).na);
    features_mat_nt.mean_video(4,voluntaria).na=mean(in_s(4,voluntaria).na);
    
    features_mat_nt.mean_video(1,voluntaria).a=mean(in_s(1,voluntaria).a);
    features_mat_nt.mean_video(2,voluntaria).a=mean(in_s(2,voluntaria).a);
    features_mat_nt.mean_video(3,voluntaria).a=mean(in_s(3,voluntaria).a);
    features_mat_nt.mean_video(4,voluntaria).a=mean(in_s(4,voluntaria).a);
end
for voluntaria=1:21
    %% Mean
...
%     features_mat_nt(4,voluntaria).features.a.std_video=std(resultados_nt_reordered(4,voluntaria).a);
    ...
    features_mat_nt.std_video(1,voluntaria).da=std(in_s(1,voluntaria).da);
    features_mat_nt.std_video(2,voluntaria).da=std(in_s(2,voluntaria).da);
    features_mat_nt.std_video(3,voluntaria).da=std(in_s(3,voluntaria).da);
    features_mat_nt.std_video(4,voluntaria).da=std(in_s(4,voluntaria).da);
    
    features_mat_nt.std_video(1,voluntaria).na=std(in_s(1,voluntaria).na);
    features_mat_nt.std_video(2,voluntaria).na=std(in_s(2,voluntaria).na);
    features_mat_nt.std_video(3,voluntaria).na=std(in_s(3,voluntaria).na);
    features_mat_nt.std_video(4,voluntaria).na=std(in_s(4,voluntaria).na);
    
    features_mat_nt.std_video(1,voluntaria).a=std(in_s(1,voluntaria).a);
    features_mat_nt.std_video(2,voluntaria).a=std(in_s(2,voluntaria).a);
    features_mat_nt.std_video(3,voluntaria).a=std(in_s(3,voluntaria).a);
    features_mat_nt.std_video(4,voluntaria).a=std(in_s(4,voluntaria).a);

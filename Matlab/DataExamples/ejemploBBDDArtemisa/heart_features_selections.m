...
%              feat_out.features{loop1,loop2}.EH.Video.HR_feats.source={'bvp'};
            
         elseif (s{loop2,loop1}=='ecg')
...
%              feat_out.features{loop1,loop2}.EH.Video.HR_feats.source={'ecg'};
         else
